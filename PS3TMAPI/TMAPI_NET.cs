...
public class PS3TMAPI
{
    ...
    public static PS3TMAPI.SNRESULT ListTargetTypes(out PS3TMAPI.TargetType[] targetTypes)
    {
        ...
        if (PS3TMAPI.FAILED(res2))
            return res2;
        IntPtr size1 = (IntPtr)size;
        targetTypes = new PS3TMAPI.TargetType[(int)size1];
        IntPtr utf8Ptr = scopedGlobalHeapPtr.Get();
        for (uint index = 0; index < size; ++index)
        {
            IntPtr index1 = (IntPtr)index;
            targetTypes[(int)index1].Type = PS3TMAPI.Utf8ToString(utf8Ptr, 64U);
            utf8Ptr = new IntPtr(utf8Ptr.ToInt64() + 64L);
            targetTypes[(int)index1].Description = PS3TMAPI.Utf8ToString(utf8Ptr, 256U);
      ...
      out uint[] timeoutValues)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        timeoutTypes = new PS3TMAPI.TimeoutType[(int)(IntPtr)numTimeouts];
        timeoutValues = new uint[(int)(IntPtr)numTimeouts];
        if (!PS3TMAPI.Is32Bit())
      ...
      out PS3TMAPI.TTYStream[] streamArray)
    {
        ...
        streamArray = new PS3TMAPI.TTYStream[(int)(IntPtr)size];
        for (uint index = 0; index < size; ++index)
            unmanagedBuf = PS3TMAPI.ReadDataFromUnmanagedIncPtr<PS3TMAPI.TTYStream>(unmanagedBuf, ref streamArray[(int)(IntPtr)index]);
        return res2;
    }
      ...
      IntPtr data)
    {
        ...
        if (callbackAndUserData.m_callbackRaw == null)
            return;
        byte[] numArray = new byte[(int)(IntPtr)length];
    ...
    public static PS3TMAPI.SNRESULT GetProcessList(int target, out uint[] processIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res2))
            return res2;
        IntPtr unmanagedBuf = scopedGlobalHeapPtr.Get();
        processIDs = new uint[(int)(IntPtr)count];
        for (uint index = 0; index < count; ++index)
            unmanagedBuf = PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(unmanagedBuf, ref processIDs[(int)(IntPtr)index]);
        return res2;
    }
      ...
      out ulong[] spuThreadGroupIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        ppuThreadIDs = new ulong[(int)(IntPtr)numPPUThreads];
        spuThreadGroupIDs = new ulong[(int)(IntPtr)numSPUThreadGroups];
      ...
      ref PS3TMAPI.ProcessInfo processInfo)
    {
        ...
        processInfo.ThreadIDs = new ulong[(int)(IntPtr)num];
      ...
      out uint[] modules)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        modules = new uint[(int)(IntPtr)numModules];
      ...
      out PS3TMAPI.ModuleInfo moduleInfo)
    {
        ...
        moduleInfo.Segments = new PS3TMAPI.PRXSegment[(int)(IntPtr)moduleInfo.Hdr.NumSegments];
      ...
      out PS3TMAPI.ExtraModuleInfo extraModuleInfo)
    {
        ...
        moduleInfoEx.Segments = new PS3TMAPI.PRXSegmentEx[(int)(IntPtr)moduleInfoEx.Hdr.NumSegments];
      ...
      out ulong[] bpAddresses)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        bpAddresses = new ulong[(int)(IntPtr)numBreakpoints];
        if (!PS3TMAPI.Is32Bit())
      ...
      out PS3TMAPI.DebugThreadControlInfo threadCtrlInfo)
    {
        ...
        threadCtrlInfo.ControlKeywords = new PS3TMAPI.ControlKeywordEntry[(int)(IntPtr)numEntries];
        for (uint index = 0; index < numEntries; ++index)
        {
            num = PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(num, ref threadCtrlInfo.ControlKeywords[(int)(IntPtr)index].MatchConditionFlags);
            threadCtrlInfo.ControlKeywords[(int)(IntPtr)index].Keyword = PS3TMAPI.Utf8ToString(num, 128U);
      ...
      out PS3TMAPI.ProcessTreeBranch[] processTree)
    {
        ...
        if (PS3TMAPI.FAILED(res2))
            return res2;
        processTree = new PS3TMAPI.ProcessTreeBranch[(int)(IntPtr)numProcesses];
        for (int index1 = 0; (long)index1 < (long)numProcesses; ++index1)
        {
            ...
            processTree[index1].PPUThreadStatuses = new PS3TMAPI.PPUThreadStatus[(int)(IntPtr)structure.NumPpuThreads];
            processTree[index1].SPUThreadGroupStatuses = new PS3TMAPI.SPUThreadGroupStatus[(int)(IntPtr)structure.NumSpuThreadGroups];
      ...
      out PS3TMAPI.SPUThreadGroupInfo threadGroupInfo)
    {
        ...
        threadGroupInfo.ThreadIDs = new uint[(int)(IntPtr)storage.NumThreads];
      ...
      out PS3TMAPI.VirtualMemoryArea[] vmAreas)
    {
        ...
        if (PS3TMAPI.FAILED(res2))
            return res2;
        vmAreas = new PS3TMAPI.VirtualMemoryArea[(int)(IntPtr)areaCount];
      ...
      out uint[] mutexIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        mutexIDs = new uint[(int)(IntPtr)numMutexes];
      ...
      out PS3TMAPI.MutexInfo mutexInfo)
    {
        ...
        mutexInfo.WaitingThreads = new ulong[(int)(IntPtr)storage];
      ...
      out uint[] lwMutexIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        lwMutexIDs = new uint[(int)(IntPtr)numLWMutexes];
      ...
      out PS3TMAPI.LWMutexInfo lwMutexInfo)
    {
        ...
        lwMutexInfo.WaitingThreads = new ulong[(int)(IntPtr)storage.NumWaitingThreads];
      ...
      out uint[] conditionVarIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        conditionVarIDs = new uint[(int)(IntPtr)numConditionVars];
      ...
      out PS3TMAPI.ConditionVarInfo conditionVarInfo)
    {
        ...
        conditionVarInfo.WaitingThreads = new ulong[(int)(IntPtr)storage.NumWaitingThreads];
        for (int index = 0; (long)index < (long)storage.NumWaitingThreads; ++index)
      ...
      out uint[] lwConditionVarIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        lwConditionVarIDs = new uint[(int)(IntPtr)numLWConditionVars];
      ...
      out PS3TMAPI.LWConditionVarInfo lwConditonVarInfo)
    {
        ...
        lwConditonVarInfo.WaitingThreads = new ulong[(int)(IntPtr)storage.NumWaitingThreads];
        for (int index = 0; (long)index < (long)storage.NumWaitingThreads; ++index)
      ...
      out uint[] rwLockList)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        rwLockList = new uint[(int)(IntPtr)numRWLocks];
      ...
      out PS3TMAPI.RWLockInfo rwLockInfo)
    {
        ...
        rwLockInfo.WaitingThreads = new ulong[(int)(IntPtr)num];
        for (int index = 0; (long)index < (long)num; ++index)
      ...
      out uint[] semaphoreIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        semaphoreIDs = new uint[(int)(IntPtr)numSemaphores];
      ...
      out PS3TMAPI.SemaphoreInfo semaphoreInfo)
    {
        ...
        semaphoreInfo.WaitingThreads = new ulong[(int)(IntPtr)storage.NumWaitingThreads];
        for (int index = 0; (long)index < (long)storage.NumWaitingThreads; ++index)
      ...
      out uint[] eventQueueIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        eventQueueIDs = new uint[(int)(IntPtr)numEventQueues];
      ...
      out PS3TMAPI.EventQueueInfo eventQueueInfo)
    {
        ...
        eventQueueInfo.WaitingThreadIDs = new ulong[(int)(IntPtr)structure.NumWaitingThreads];
        ...
        eventQueueInfo.QueueEntries = new PS3TMAPI.SystemEvent[(int)(IntPtr)structure.NumReadableEvQueue];
      ...
      out uint[] eventFlagIDs)
    {
        ...
        if (PS3TMAPI.FAILED(res))
            return res;
        eventFlagIDs = new uint[(int)(IntPtr)numEventFlags];
      ...
      out PS3TMAPI.EventFlagInfo eventFlagInfo)
    {
        ...
        eventFlagInfo.WaitingThreads = new PS3TMAPI.EventFlagWaitThread[(int)(IntPtr)storage];
        for (int index = 0; (long)index < (long)storage; ++index)
      ...
      out PS3TMAPI.MATRange[] matRanges)
    {
        ...
        if (PS3TMAPI.FAILED(res2))
            return res2;
        IntPtr unmanagedBuf = scopedGlobalHeapPtr.Get();
        matRanges = new PS3TMAPI.MATRange[(int)(IntPtr)rangeCount];
        for (uint index = 0; index < rangeCount; ++index)
            unmanagedBuf = PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(PS3TMAPI.ReadDataFromUnmanagedIncPtr<uint>(unmanagedBuf, ref matRanges[(int)(IntPtr)index].StartAddress), ref matRanges[(int)(IntPtr)index].Size);
        return res2;
    }
      ...
      ref PS3TMAPI.MATRange[] matRanges)
    {
        ...
        for (int index1 = 0; (long)index1 < (long)length; ++index1)
        {
            ...
            matRanges[index1].PageConditions = new PS3TMAPI.MATCondition[(int)(IntPtr)num];
      ...
      IntPtr data)
    {
        ...
        if (length > 0U)
        {
            ...
            ftpNotifications = new PS3TMAPI.FTPNotification[(int)(IntPtr)num];
            for (int index = 0; (long)index < (long)num; ++index)
      ...
      IntPtr data)
    {
        ...
        if (length < num2)
            return;
        fileTraceEvent.BackTraceData = new byte[(int)(IntPtr)storage3];
        ...
        switch (fileTraceEvent.TraceType)
        {
            ...
            case PS3TMAPI.FileTraceType.WidgetOpen:
                ...
                fileTraceEvent.LogData.LogType8.VArg = new byte[(int)(IntPtr)storage10];
      ...
      out PS3TMAPI.FileTransferInfo[] fileTransfers)
    {
        ...
        fileTransfers = new PS3TMAPI.FileTransferInfo[(int)(IntPtr)count];
        for (uint index = 0; index < count; ++index)
            dataPtr = PS3TMAPI.FileTransferInfoMarshalHelper(dataPtr, ref fileTransfers[(int)(IntPtr)index]);
        return res2;
    }
      ...
      out PS3TMAPI.DirEntry[] dirEntries)
    {
        ...
        if (PS3TMAPI.SUCCEEDED(res2))
        {
            ...
            dirEntries = new PS3TMAPI.DirEntry[(int)(IntPtr)numDirEntries];
      ...
      out PS3TMAPI.TargetTimezone timeZone)
    {
        ...
        {
            IntPtr dataPtr = scopedGlobalHeapPtr2.Get();
            dirEntries = new PS3TMAPI.DirEntryEx[(int)(IntPtr)numDirEntries];
            for (int index = 0; (long)index < (long)numDirEntries; ++index)
